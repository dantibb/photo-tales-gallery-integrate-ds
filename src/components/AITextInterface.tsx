...
import { MessageCircle, Send, Save, RotateCcw, Mic, MicOff, Volume2, User, Bot } from 'lucide-react';
import { interviewApi, InterviewMessage, MediaItem } from '../services/api';
import { mediaApi } from '../services/api';

interface AITextInterfaceProps {
  media: MediaItem;
  onClose: () => void;
  onSave?: () => void;
...
export const AITextInterface: React.FC<AITextInterfaceProps> = ({ media, onClose, onSave, onMessagesChange }) => {
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Chat with AI about this image (Text Mode)
            </CardDescription>
          </div>
      ...
      <CardContent>
        {!isStarted ? (
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-semibold mb-2">Start AI Text Chat</h3>
